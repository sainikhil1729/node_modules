...
/******** OWNER NUMBER**********/
const ownerNumber = ["916302783815@s.whatsapp.net"]   // Ganti Nomor Lu
const pacarNumber = ["919505579643@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
...
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "type #menu buddy", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})}
		...
		//bad word detect end//
		  ...
		  //kolor
		  ['red','white','black','blue','yellow','green', 'aqua']
           ...
           //detector media  end//
		    ...
		    //case menu//
                switch(command) {
		            ...
		            case 'menu':
		            case '?':
	 // Don't Delete TQTO No need to delete your self esteem, I'm tired of fixing it
...
║✨ ${prefix}glow
║✨ ${prefix}summer
║✨ ${prefix}flower//case audio menu//
║✨ ${prefix}neonglow
╙───々
╓───「 *_ғᴜɴ ᴍᴇɴᴜ_* 」
║❏ ${prefix}ɴᴜʟɪꜱ
║❏ ${prefix}ʜɪʟɪʜ//case audio menu//
║❏ ${prefix}ᴅᴀʀᴋᴊᴏᴋᴇꜱ
║❏ ${prefix}ʙᴜᴄɪɴ
║❏ ${prefix}ᴋᴀᴛᴀᴅɪʟᴀɴ
║❏ ${prefix}ʜᴇᴋᴇʀʙᴜᴄɪɴ
║❏ ${prefix}ᴋᴀᴛᴀɪʟʜᴀᴍ//case audio menu//
║❏ ${prefix}ʀᴇᴀᴅᴍᴏʀᴇ
║❏ ${prefix}ᴄᴀᴋʟᴏɴᴛᴏɴɢ
╙───々
╓───「 *_TEEN 🔞 ᴍᴇɴᴜ_* 」
